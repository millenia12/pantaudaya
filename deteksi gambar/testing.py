...
app = Flask(__name__)
app.config['UPLOAD_FOLDER'] = 'upload_pju'
CORS(app)
...
model = load_model('C:/xampp/htdocs/deteksi gambar/datasetpju.h5')
...
def run(file):
    ...
    if img_file is not None:
        ...
        save_image_path = 'C:/xampp/htdocs/deteksi gambar/upload_pju/'+img_file.name
